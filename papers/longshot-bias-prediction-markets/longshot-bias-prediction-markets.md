...
Slot machines on the Las Vegas Strip return about 93 cents on the dollar, widely considered some of the worst odds in gambling. On Kalshi, a CFTC-regulated prediction market, over \$240 million has been wagered on longshot contracts that return as low as 43 cents on the dollar. Thousands of traders are making bets that offer half the expected value of a slot machine.

The [efficient market hypothesis](https://www.jstor.org/stable/2325486), in its strong form, suggests that asset prices perfectly aggregate all information available to market participants. Prediction markets, where contracts pay \$1 if an event occurs and \$0 otherwise, should be the purest test of this theory. Unlike stocks, there's no ambiguity about intrinsic value: the contract either pays out or it doesn't. That said, a contract trading at 50 cents should theoretically reflect exactly a 50% probability.
